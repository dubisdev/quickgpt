...
export const SettingsIcon = () => {
    ...
    const isSettings = location === Routes.Settings

    const navigateRoute = isSettings ? Routes.Response : Routes.Settings

    return <button className={styles.settingsIcon} onClick={() => navigateTo(navigateRoute)}>
